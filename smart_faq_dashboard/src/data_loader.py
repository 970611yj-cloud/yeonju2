...
def load_data(sheet_url, csv_file=None):
    ...
    # Assuming app.py runs from root of smart_faq_dashboard, or we look relative to this file
    ...
    if os.path.exists(default_csv_path):
        try:
            ...
            # ... (clean columns logic repeated or helper function preferable, but inline for now) ...
            df.columns = df.columns.str.strip()
            df = df.loc[:, ~df.columns.str.contains('^Unnamed')]
